...
# Allow tests to point to a temp file: export TASKS3_DATA=/path/to/tmp.json
DATA_FILE = os.environ.get("TASKS3_DATA", os.path.join(os.path.dirname(__file__), "tasks.json"))
ISO = "%Y-%m-%dT%H:%M:%S"
